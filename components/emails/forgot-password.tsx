...
const ForgotPassword = ({ verificationUrl }: ForgotPasswordProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          ...
          {siteConfig.name} account. If you made this request, please click the
          button above to reset your password.
        </Text>
